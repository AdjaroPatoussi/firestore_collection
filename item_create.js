...
const sample_collection = firestore.collection('sample_collection').doc('mon_document').collection('mon_notre_document');
...
let database = require('./sample_database.json');
